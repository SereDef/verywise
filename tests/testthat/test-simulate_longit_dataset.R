...
test_that("simulate_longit_dataset creates phenotype file and calls simulate_freesurfer_data", {
...
test_that("simulate_longit_dataset respects overwrite argument", {
...
test_that("simulate_longit_dataset handles simulate_association argument", {
  tmp <- tempdir()
