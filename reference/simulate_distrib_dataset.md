...
#> ! `path` specified (/tmp/Rtmp0yxFLB/fed_simulation1c4e57c35b70) does not exist.
...
#> ! `site_dir` specified (/tmp/Rtmp0yxFLB/fed_simulation1c4e57c35b70/site1) does
#>   not exist.
#> ⠙ [site1] writing 80 surface files
#>   I'll try to create it.
#> ⠙ [site1] writing 80 surface files
...
#> ! `site_dir` specified (/tmp/Rtmp0yxFLB/fed_simulation1c4e57c35b70/site2) does
#>   not exist.
#> ⠙ [site2] writing 120 surface files
#>   I'll try to create it.
#> ⠙ [site2] writing 120 surface files
...
#> ! `site_dir` specified (/tmp/Rtmp0yxFLB/fed_simulation1c4e57c35b70/site3) does
#>   not exist.
#> ⠙ [site3] writing 60 surface files
#>   I'll try to create it.
#> ⠙ [site3] writing 60 surface files
