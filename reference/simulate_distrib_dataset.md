...
#> ── Simulating distributed dataset ─────────────────────────── verywise v1.3.7 ──
#> ! `path` specified (/tmp/RtmpCjYjS8/fed_simulation1af31360e3e6) does not exist.
...
#> ! `site_dir` specified (/tmp/RtmpCjYjS8/fed_simulation1af31360e3e6/site1) does
#>   not exist.
#> ⠙ [site1] writing 80 surface files
#>   I'll try to create it.
#> ⠙ [site1] writing 80 surface files
...
#> ! `site_dir` specified (/tmp/RtmpCjYjS8/fed_simulation1af31360e3e6/site2) does
#>   not exist.
#> ⠙ [site2] writing 120 surface files
#>   I'll try to create it.
#> ⠙ [site2] writing 120 surface files
#> ✔ [site2] writing 120 surface files [2ms]
#> 
#> ⠙ [site3] writing 60 surface files
#> ! `site_dir` specified (/tmp/RtmpCjYjS8/fed_simulation1af31360e3e6/site3) does
#>   not exist.
#> ⠙ [site3] writing 60 surface files
#>   I'll try to create it.
#> ⠙ [site3] writing 60 surface files
#> ✔ [site3] writing 60 surface files [2ms]
#> 
#> 
#> ── Done! :) ────────────────────────────────────────────────────────────────────
