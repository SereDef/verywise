...
#> • the `path` specified ('/tmp/RtmpHmr8v4/fed_simulation1babc060d28') does not
...
#> 1.7
#> %)
#> • the `site_dir` specified ('/tmp/RtmpHmr8v4/fed_simulation1babc060d28/site1')
...
#> 80
#> surface files...
#> • the `site_dir` specified ('/tmp/RtmpHmr8v4/fed_simulation1babc060d28/site2')
#>   does not exist. I'll try to create it.
#> * [
#> site2
#> ] writing
#> 120
#> surface files...
#> • the `site_dir` specified ('/tmp/RtmpHmr8v4/fed_simulation1babc060d28/site3')
#>   does not exist. I'll try to create it.
#> * [
#> site3
#> ] writing
