...
#> • the `path` specified ('/tmp/RtmpaJmMZD/fed_simulation1c135bbc5375') does not
...
#> 1.7
#> %)
#> • the `site_dir` specified ('/tmp/RtmpaJmMZD/fed_simulation1c135bbc5375/site1')
...
#> 80
#> surface files...
#> • the `site_dir` specified ('/tmp/RtmpaJmMZD/fed_simulation1c135bbc5375/site2')
#>   does not exist. I'll try to create it.
#> * [
#> site2
#> ] writing
#> 120
#> surface files...
#> • the `site_dir` specified ('/tmp/RtmpaJmMZD/fed_simulation1c135bbc5375/site3')
#>   does not exist. I'll try to create it.
#> * [
#> site3
#> ] writing
