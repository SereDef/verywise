...
#> ── Simulating distributed dataset ────────────────────── verywise v1.3.5.9000 ──
#> ! `path` specified (/tmp/RtmpoevUYS/fed_simulation1cc120ca489c) does not exist.
...
#> ! `site_dir` specified (/tmp/RtmpoevUYS/fed_simulation1cc120ca489c/site1) does
#>   not exist.
#> ⠙ [site1] writing 80 surface files
#>   I'll try to create it.
#> ⠙ [site1] writing 80 surface files
...
#> ! `site_dir` specified (/tmp/RtmpoevUYS/fed_simulation1cc120ca489c/site2) does
#>   not exist.
#> ⠙ [site2] writing 120 surface files
#>   I'll try to create it.
#> ⠙ [site2] writing 120 surface files
...
#> ! `site_dir` specified (/tmp/RtmpoevUYS/fed_simulation1cc120ca489c/site3) does
#>   not exist.
#> ⠙ [site3] writing 60 surface files
#>   I'll try to create it.
#> ⠙ [site3] writing 60 surface files
