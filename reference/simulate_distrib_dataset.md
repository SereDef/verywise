...
#> • the `path` specified ('/tmp/RtmpbFO4v3/fed_simulation1c783472a8bf') does not
...
#> 1.7
#> %)
#> • the `site_dir` specified ('/tmp/RtmpbFO4v3/fed_simulation1c783472a8bf/site1')
...
#> 80
#> surface files...
#> • the `site_dir` specified ('/tmp/RtmpbFO4v3/fed_simulation1c783472a8bf/site2')
#>   does not exist. I'll try to create it.
#> * [
#> site2
#> ] writing
#> 120
#> surface files...
#> • the `site_dir` specified ('/tmp/RtmpbFO4v3/fed_simulation1c783472a8bf/site3')
#>   does not exist. I'll try to create it.
#> * [
#> site3
#> ] writing
