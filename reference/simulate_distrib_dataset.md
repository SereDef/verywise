...
#> ! `path` specified (/tmp/Rtmp6JvdG8/fed_simulation1ceb48bfca53) does not exist.
...
#> ! `site_dir` specified (/tmp/Rtmp6JvdG8/fed_simulation1ceb48bfca53/site1) does
#>   not exist.
#> ⠙ [site1] writing 80 surface files
#>   I'll try to create it.
#> ⠙ [site1] writing 80 surface files
...
#> ! `site_dir` specified (/tmp/Rtmp6JvdG8/fed_simulation1ceb48bfca53/site2) does
#>   not exist.
#> ⠙ [site2] writing 120 surface files
#>   I'll try to create it.
#> ⠙ [site2] writing 120 surface files
...
#> ! `site_dir` specified (/tmp/Rtmp6JvdG8/fed_simulation1ceb48bfca53/site3) does
#>   not exist.
#> ⠙ [site3] writing 60 surface files
#>   I'll try to create it.
#> ⠙ [site3] writing 60 surface files
