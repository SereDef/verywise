...
#> • the `path` specified ('/tmp/Rtmp2XnxuV/fed_simulation1c8a368a058c') does not
...
#> 1.7
#> %)
#> • the `site_dir` specified ('/tmp/Rtmp2XnxuV/fed_simulation1c8a368a058c/site1')
...
#> 80
#> surface files...
#> • the `site_dir` specified ('/tmp/Rtmp2XnxuV/fed_simulation1c8a368a058c/site2')
#>   does not exist. I'll try to create it.
#> * [
#> site2
#> ] writing
#> 120
#> surface files...
#> • the `site_dir` specified ('/tmp/Rtmp2XnxuV/fed_simulation1c8a368a058c/site3')
#>   does not exist. I'll try to create it.
#> * [
#> site3
#> ] writing
