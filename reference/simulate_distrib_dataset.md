...
#> • the `path` specified ('/tmp/RtmpvNpXlh/fed_simulation1c7923db47d5') does not
...
#> 1.7
#> %)
#> • the `site_dir` specified ('/tmp/RtmpvNpXlh/fed_simulation1c7923db47d5/site1')
...
#> 80
#> surface files...
#> • the `site_dir` specified ('/tmp/RtmpvNpXlh/fed_simulation1c7923db47d5/site2')
#>   does not exist. I'll try to create it.
#> * [
#> site2
#> ] writing
#> 120
#> surface files...
#> • the `site_dir` specified ('/tmp/RtmpvNpXlh/fed_simulation1c7923db47d5/site3')
#>   does not exist. I'll try to create it.
#> * [
#> site3
#> ] writing
