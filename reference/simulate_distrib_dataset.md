...
#> • the `path` specified ('/tmp/Rtmp2hUbPO/fed_simulation1cb879475c4d') does not
#>   exist. I'll try to create it.
#> • selected 11 vertices (1.7%)
#> • the `site_dir` specified ('/tmp/Rtmp2hUbPO/fed_simulation1cb879475c4d/site1')
#>   does not exist. I'll try to create it.
#> • [site1] writing 80 surface files...
#> • the `site_dir` specified ('/tmp/Rtmp2hUbPO/fed_simulation1cb879475c4d/site2')
#>   does not exist. I'll try to create it.
#> • [site2] writing 120 surface files...
#> • the `site_dir` specified ('/tmp/Rtmp2hUbPO/fed_simulation1cb879475c4d/site3')
#>   does not exist. I'll try to create it.
