...
#> • the `path` specified ('/tmp/Rtmp94psxP/fed_simulation1c99545e7f4b') does not
...
#> • the `site_dir` specified ('/tmp/Rtmp94psxP/fed_simulation1c99545e7f4b/site1')
#>   does not exist. I'll try to create it.
#> ⠙ [site1] writing 80 surface files
#> ✔ [site1] writing 80 surface files [3ms]
#> 
#> ⠙ [site2] writing 120 surface files
#> • the `site_dir` specified ('/tmp/Rtmp94psxP/fed_simulation1c99545e7f4b/site2')
#>   does not exist. I'll try to create it.
#> ⠙ [site2] writing 120 surface files
#> ✔ [site2] writing 120 surface files [4ms]
#> 
#> ⠙ [site3] writing 60 surface files
#> • the `site_dir` specified ('/tmp/Rtmp94psxP/fed_simulation1c99545e7f4b/site3')
#>   does not exist. I'll try to create it.
#> ⠙ [site3] writing 60 surface files
