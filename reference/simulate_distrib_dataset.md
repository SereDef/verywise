...
#> • the `path` specified ('/tmp/RtmpgxRcwl/fed_simulation1da55623f7a2') does not
...
#> • the `site_dir` specified ('/tmp/RtmpgxRcwl/fed_simulation1da55623f7a2/site1')
#>   does not exist. I'll try to create it.
#> ⠙ [site1] writing 80 surface files
#> ✔ [site1] writing 80 surface files [3ms]
#> 
#> ⠙ [site2] writing 120 surface files
#> • the `site_dir` specified ('/tmp/RtmpgxRcwl/fed_simulation1da55623f7a2/site2')
#>   does not exist. I'll try to create it.
#> ⠙ [site2] writing 120 surface files
#> ✔ [site2] writing 120 surface files [5ms]
#> 
#> ⠙ [site3] writing 60 surface files
#> • the `site_dir` specified ('/tmp/RtmpgxRcwl/fed_simulation1da55623f7a2/site3')
#>   does not exist. I'll try to create it.
#> ⠙ [site3] writing 60 surface files
