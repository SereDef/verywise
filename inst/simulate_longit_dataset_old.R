...
#'   progress messages.
#' @param ... Additional arguments passed to \code{\link{simulate_freesurfer_data2}}.
#'
#'
#' @seealso
...
#' @export
#'
simulate_longit_dataset2 <- function(path,
...
#' @export
#'
simulate_long_pheno_data2 <- function(data_structure = list(
                                       "cohort1" = list(
                                         "sessions" = c("01", "02"),
                                         "n_subjects" = 100
                                       ),
...
#'
#' @seealso
#' \code{\link{simulate_longit_dataset2}}, \code{\link{simulate_long_pheno_data2}}
#'
#' @export
#'
simulate_freesurfer_data2 <- function(path,
                                     data_structure = list(
                                       "cohort1" = list(
                                         "sessions" = c("01", "02"),
                                         "n_subjects" = 100
